...
class _CarteScreenState extends State<CarteScreen> {
  ...
  getData() {
    singleStoreData(id: controller.storeId, filterId: widget.filterId).then((value1) {
      apiLoaded = true;
      model = value1;
      setState(() {});
    });
  ...
  Widget build(BuildContext context) {
    return apiLoaded && model.data != null
                              ...
                              children: [
                                ...
                                Positioned(
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        wishlistRepo(
                                            productId: model.data!.latestProducts![index].id
                                                .toString(),
                                            id: '')
                                            .then((value) {
                                          ...
                                          onTap: () {
                                            ...
                                            if (product.productCount <
                                              ...
                                              model.data!.latestProducts![index].qty == 0
                                                  ...
                                                  .then((value1) {
                                                if (value1.status == true) {
                                                  model.data!.latestProducts![index].value =
                                                  true;
                                                  // model.data!.latestProducts![index].buttonCount.value++;
                                                  showToast(value1.message.toString());
