...
class _OrderDetailsScreenState extends State<OrderDetailsScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                   ...
                   Obx(() {
                     return
                       ...
                       child: Padding(
                         ...
                         child: controller.isDataLoading.value && controller.model.value.orderDetail != null ? Column(
                           children: [
                             addHeight(10),
                             Container(
                         ...
                         child: Padding(
                           ...
                           Column(
                               children: [
                                 ...
                                 //               const Spacer(),
                                 //
                                 //               Text( "€ ${controller.model.value.orderDetail!.couponDiscount!.discountedPrice.toString()}",
                                 //                 style: GoogleFonts.poppins(
                                 //                     fontSize: 14,
                                 //                     fontWeight: FontWeight.w500,
                                 //                     color: const Color(0xff486769)
                                                 ...
                                                 children: [
                                                   ...
                                                   Row(
                                                     ...
                                                     children: [
                                                       ...
                                                       const Spacer(),
                                                       Text( '€ ${controller.model.value.orderDetail!.tipAmount.toString()}',
                                                         style: GoogleFonts.poppins(
                                                             fontSize: 14,
                                                             fontWeight: FontWeight.w500,
                                                             color: const Color(0xff486769)
                         ...
                         child: Padding(
                           ...
                           Column(
                             children: [
                               ...
                               InkWell(
                                 onTap: (){
                                   Get.toNamed(ChatScreen1.chatScreen1);
                                 },
      ...
      Obx((){
        return
         controller.model.value.orderDetail != null ? controller.model.value.orderDetail!.deliveryStatus == "Completed" && controller.model.value.orderDetail!.feedback == false ?
        InkWell(
          onTap: () {
            Get.toNamed(MyRouters.reviewScreen);
          },
