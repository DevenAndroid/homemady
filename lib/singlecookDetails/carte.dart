                  ...
                  Padding(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        String productID = controller.model.value.data!.latestProducts![index].id.toString().trim();
                        controller.model.value.data!.latestProducts![index].productCount = int.tryParse((cartListController
                                        ...
                                        children: [
                                                ...
                                                children: [
                                                  ClipRRect(
                                                    ...
                                                    child: CachedNetworkImage(
                                                      imageUrl: controller.model.value.data!.latestProducts![index].image
                                                          .toString(),
                                                      fit: BoxFit.cover,
                                                      height: 110,
                                                      width: 75,
                                                  ...
                                                  Positioned(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        child: controller.model.value.data!.latestProducts![index].wishlist
                                                            ? Container(
                                                                height: 23,
                                                  ...
                                                  children: [
                                                    ...
                                                    Row(
                                                      children: [
                                                        ...
                                                        Expanded(
                                                          child: Text(
                                                            controller.model.value.data!.latestProducts![index].spiciness
                                                                .toString(),
                                                            style: GoogleFonts.poppins(
                                                                fontWeight: FontWeight.w500,
                                                                fontSize: 10,
                                                    ...
                                                    Row(
                                                      children: [
                                                        ...
                                                        Expanded(
                                                          child: Text(
                                                            controller.model.value.data!.latestProducts![index].allergens
                                                                .toString()
                                                                .capitalizeFirst
                                                                .toString(),
                                                            style: GoogleFonts.poppins(
                                                              ...
                                                              if (cartListController.model.value.data!.cartItems!
                                                                ...
                                                                addToCartRepo(
                                                                  ...
                                                                  if (value1.status == true) {
                                                                    controller.model.value.data!.latestProducts![index]
                                                                        .value = true;
                                                                    // controller.model.value.data!.latestProducts![index].buttonCount.value--;
                                                          ...
                                                          InkWell(
                                                            onTap: () {
                                                              ...
                                                              if (product.productCount <
                                                                  controller.model.value.data!.latestProducts![index].qty) {
                                                                controller.model.value.data!.latestProducts![index].qty == 0
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Expanded(child: controller.model.value.data!.latestProducts![index].qty == 0
                                                  ? Text(
                                                '0 Units',
                                                style: GoogleFonts.poppins(
                                                    fontWeight: FontWeight.w500,
                                          ...
                                          addHeight(4),
                                          if(controller.model.value.data!.latestProducts![index].special_offer == true)
                                          Row(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            mainAxisAlignment: MainAxisAlignment.start,
                                            children: [
