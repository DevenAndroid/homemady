                    ...
                    child:
                      ...
                      ListView.builder(
                          ...
                          itemBuilder: (BuildContext, index) {
                            return InkWell(
                              onTap: () {
                                Get.off(() => FilterProductScreen(
                                      filterId: items[index].id,
                                    ));
                              },
                              child: Padding(
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: filterDataController.isDataLoading
            ? SizedBox(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        addHeight(26),
                        filterDataController.filterModel.value.data != null &&
                                filterDataController.filterModel.value.data!.isNotEmpty
                            ? ListView.builder(
                                physics: const BouncingScrollPhysics(),
                                ...
                                itemBuilder: (context, index) {
                                  String productID =
                                      filterDataController.filterModel.value.data![index].id.toString().trim();
                                  filterDataController.filterModel.value.data![index].productCount = int.tryParse(
                                        ...
                                        child: InkWell(
                                          ...
                                          child: Column(
                                            children: [
                                                    ...
                                                    children: [
                                                      ClipRRect(
                                                        ...
                                                        child: CachedNetworkImage(
                                                          imageUrl: filterDataController
                                                              .filterModel.value.data![index].image
                                                              .toString(),
                                                          fit: BoxFit.cover,
                                                          height: 110,
                                                          width: 75,
                                                      ...
                                                      Positioned(
                                                          ...
                                                          child: GestureDetector(
                                                              onTap: () {
                                                                wishlistRepo(
                                                                        productId: filterDataController
                                                                            .filterModel.value.data![index].id
                                                                            .toString(),
                                                                        id: '')
                                                                    .then((value) {
                                                              ...
                                                              child: filterDataController
                                                                      .filterModel.value.data![index].wishlist!
                                                                  ? Container(
                                                                      height: 23,
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          (filterDataController
                                                                      .filterModel.value.data![index].subTitle ??
                                                                  '')
                                                              .toString(),
                                                          style: GoogleFonts.poppins(
                                                              fontWeight: FontWeight.w300,
                                                        ...
                                                        Row(
                                                          children: [
                                                            ...
                                                            Text(
                                                              filterDataController
                                                                      .filterModel.value.data![index].sizeId ??
                                                                  ''.toString(),
                                                              style: GoogleFonts.poppins(
                                                                  fontWeight: FontWeight.w300,
                                                                  fontSize: 11,
                                                        ...
                                                        Row(
                                                          children: [
                                                            ...
                                                            addWidth(6),
                                                            Text(
                                                                "${filterDataController.filterModel.value.data![index].distance.toString()} Km",
                                                                style: GoogleFonts.poppins(
                                                                  fontSize: 13,
                                                        ...
                                                        Row(
                                                          children: [
                                                            ...
                                                            Expanded(
                                                              child: Text(
                                                                filterDataController
                                                                        .filterModel.value.data![index].spiciness ??
                                                                    ''.toString(),
                                                          ...
                                                          children: [
                                                            ...
                                                            Expanded(
                                                              child: Text(
                                                                ...
                                                                filterDataController
                                                                    .filterModel.value.data![index].allergen!
                                                              ...
                                                              InkWell(
                                                                onTap: () {
                                                                  if (cartListController.model.value.data!.cartItems!
                                                                    ...
                                                                    addToCartRepo(
                                                                            product_id: filterDataController
                                                                                .filterModel.value.data![index].id
                                                                                .toString(),
                                                                      ...
                                                                      if (value1.status == true) {
                                                                        filterDataController.filterModel.value
                                                              ...
                                                              InkWell(
                                                                onTap: () {
                                                                  ...
                                                                  if (product.productCount <
                                                                      int.parse(filterDataController
                                                                          .filterModel.value.data![index].cookUnitDays
                                                                          .toString())) {
                                                                    addToCartRepo(
                                                                            product_id: filterDataController
                                                                                .filterModel.value.data![index].id
                                              ...
                                              if (filterDataController.filterModel.value.data![index].special_offer ==
                                                  true) ...[
                                                addHeight(4),
                                                Row(
                                                  crossAxisAlignment: CrossAxisAlignment.start,
