                              ...
                              Column(
                                children: [
                                  Text(
                                    '9.99',
                                    style: TextStyle(
                                        fontSize: 40, fontFamily: 'Graphit.ttf', fontWeight: FontWeight.w600, color: Colors.white),
                                  ),
                                  SizedBox(
                                    height: 5,
                                  ),
                                  Text(
                                    'Per Month',
                                    style: TextStyle(fontSize: 15, height: .05, fontWeight: FontWeight.w500, color: Colors.white),
                                  ),
                                ],
                              ),
                              Column(
                                children: [
                                  Text(
                                    '€',
                                    style: TextStyle(fontSize: 20, height: 1.5, fontWeight: FontWeight.w600, color: Colors.white),
                                  ),
                                ],
                              ),
                            ],
