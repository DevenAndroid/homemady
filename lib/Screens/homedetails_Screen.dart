                  ...
                  controller: scrollController,
                    headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
                      return [
                                        ...
                                        child: Row(
                                          children: [
                                            Row(
                                              children: [
                                                ...List.generate(
                                                    controller.model.value.data!.storeDetails!.award!.length, (index1) {
                                                  return InkWell(
                                                    onTap: () {
                                                      showGeneralDialog(
                                                          context: context,
                        ...
                        CustomMadeAppBar(tabController: tabControllerGG,scrollController: scrollController,),
                        // SliverAppBar(
                        //     pinned: true,
                        //     floating: false,
                        //     titleSpacing: 0,
...
class CustomMadeAppBar extends StatefulWidget {
  const CustomMadeAppBar({super.key, required this.tabController, required this.scrollController});
  final TabController tabController;
  final ScrollController scrollController;
  @override
  State<CustomMadeAppBar> createState() => _CustomMadeAppBarState();
}

class _CustomMadeAppBarState extends State<CustomMadeAppBar> {
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (BuildContext c, Widget? child) {
        ...
        double thrustHold = (490-kToolbarHeight);
        bool itsNegative = widget.scrollController.offset - thrustHold < 0;
        return SliverAppBar(
          pinned: true,
          floating: false,
          titleSpacing: 0,
          ...
          elevation: 0,
          primary: false,
          toolbarHeight: kToolbarHeight+(min((itsNegative ? 0 : widget.scrollController.offset - thrustHold), kToolbarHeight*1.4)),
          // +,
          leadingWidth: 0,
          title: Container(
            padding: EdgeInsets.only(top: (min((itsNegative ? 0 : widget.scrollController.offset - thrustHold), kToolbarHeight*1.4))),
              child: child!),
        );
      },
    );
