                      ...
                      child: Column(
                        ...
                        children: [
                          LinearPercentIndicator(
                            ...
                            percent:  double.parse(controller.model.value.data!.totalReviews![0].avg.toString()) / 7,
                          ...
                          LinearPercentIndicator(
                            ...
                            percent: double.parse(controller.model.value.data!.totalReviews![1].avg.toString()) / 7,
                            animationDuration: 1200,
                          ),
                          const SizedBox(height: 15,),
                          LinearPercentIndicator(
                            ...
                            percent: double.parse(controller.model.value.data!.totalReviews![2].avg.toString()) / 7,
                            animationDuration: 1200,
                          ),
                          const SizedBox(height: 15,),
                          LinearPercentIndicator(
                            ...
                            percent: double.parse(controller.model.value.data!.totalReviews![3].avg.toString()) / 7,
                            animationDuration: 1200,
                          ),
                        ],
                      ),
