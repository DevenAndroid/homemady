...
class _carteScreenState extends State<carteScreen> {
  ...
  Widget build(BuildContext context) {
    print(controller.model.value.data!.latestProducts!.map((e) => e.buttonCount.value));
    return Obx(() {
      return Column(
        children: [
          Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            InkWell(
                                              ...
                                              child: Container(
                                                decoration: BoxDecoration(
                                                    border: Border.all(color: const Color(0xFF72CD4A)), shape: BoxShape.circle),
                                                ...
                                                child: const Padding(
                                                  ...
                                                  child: Text(
                                                    '-',
                                                    style: TextStyle(
                                                        fontWeight: FontWeight.w600, fontSize: 16, color: Color(0xFF72CD4A)),
