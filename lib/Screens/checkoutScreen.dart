                                    ...
                                    Row(
                                      children: [
                                        Obx(() {
                                          ...
                                          'Select address' : myCartController.model.value.data!.orderAddress!.flatNo.toString()+',' +
                                              myCartController.model.value.data!.orderAddress!.landmark.toString()+',' +
                                              myCartController.model.value.data!.orderAddress!.pinCode.toString()).toString(),
                                            style: GoogleFonts.poppins(
                                                fontSize: 14,
