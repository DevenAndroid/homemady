    ...
    return Obx(() {
      return GestureDetector(
        ...
        child: Scaffold(
          ...
          body: myCartController.isDataLoading.value == false
              ? const Center(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        myCartController.model.value.data!.cartPaymentSummary!.couponCode == 0 ||
                                                myCartController.model.value.data!.cartPaymentSummary!.couponCode
                                                        .toString() ==
                                                    ""
                                            ? const SizedBox()
                                            : Obx(() {
                                                return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                  Container(
                                                    ...
                                                    decoration: const ShapeDecoration(
                                                        color: AppTheme.userActive, shape: CircleBorder()),
                                                    child: Center(
                                                        child: Icon(
                                                      Icons.check,
                                                            ...
                                                            children: [
                                                              Obx(() {
                                                                return profileController
                                                                    ...
                                                                    ? Expanded(
                                                                        child: Text(
                                                                          '${profileController.model.value.data!.defaultAddress![0].flatNo},${profileController.model.value.data!.defaultAddress![0].landmark},${profileController.model.value.data!.defaultAddress![0].pinCode}',
                                                                          style: GoogleFonts.poppins(
                                                                              fontSize: 14,
                                                                              fontWeight: FontWeight.w400,
                                                                              color: const Color(0xff5C5C60)),
                                                              ...
                                                              Obx(() {
                                                                return Expanded(
                                                                  child: Text(
                                                                    (myCartController.model.value.data!.orderAddress == null
                                                                            ? 'Select address'
                                                                            : '${myCartController.model.value.data!.orderAddress!.flatNo},${myCartController.model.value.data!.orderAddress!.landmark},${myCartController.model.value.data!.orderAddress!.pinCode}')
                                                                        .toString(),
                                                                    style: GoogleFonts.poppins(
                                                                        fontSize: 14,
                                                                        fontWeight: FontWeight.w400,
                                            ...
                                            children: [
                                              ClipRRect(
                                                ...
                                                child: CachedNetworkImage(
                                                  imageUrl:
                                                      myCartController.model.value.data!.cartItems![index].image.toString(),
                                                  fit: BoxFit.cover,
                                                  height: 76,
                                                  width: 76,
                                        ...
                                        getSavedDetailsController.isDataLoading.value &&
                                            ...
                                            ? SizedBox(
                                                ...
                                                return ListView.builder(
                                                    shrinkWrap: true,
                                                    itemCount:
                                                        getSavedDetailsController.savedDetailsModel.value.data!.length,
